...
import type { Album } from '../../../store/album.js'
...
<template>
  <div
    v-if="data"
    class="activity-item activity-album"
    :style="{ '--color-highlight': author.accentColor }"
    @click.self="go"
  >
    <div class="activity-title">
      ...
      <p @click.self="go">
        ...
        uploaded an album
        <router-link :to="{ name: 'AlbumDetail', params: { id: data.key } }">
          {{ data.title }}
        </router-link>
      </p>
    </div>
    ...
    <div class="activity-body">
      ...
      <div class="title">
        ...
        <div v-if="data.taggedUsers.length > 1" class="info">

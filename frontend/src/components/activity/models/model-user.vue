...
import { flag, getRanMinMax, RGB_TO_HEX } from '../../../js/utils.js'
...
<template>
  <div class="activity-item activity-user" :style="{ '--color-highlight': data.accentColor }" @click="go">
    <div class="title">
    ...
    <div class="user">
      ...
      <div class="info">
        ...
        <div v-if="data.country" class="nationality-wrap">
    ...
    <div class="background" :style="{ backgroundColor: RGB_TO_HEX(data.accentColor) }" />
  </div>
</template>
